...
print("----- Person -----")
person1 = Person("klao", 30, "11-03-2007", "A", "no")
print(person1.display_all_info())

print("\n----- Staff -----")
staff1 = Staff("burawitchaya", 40, "01-01-2000", "B", "yes", "IT", 2007)
staff1.set_salary(30000)
print(staff1.display_all_info())

print("\n----- Student -----")
student1 = Student("kl", 20, "12-12-1990", "O", "no", 2000, "com", "undergraduate", [3.5, 4.0, 2.5])
...
print("\n----- Professor1 -----")
professor1 = Professor("Dr.Klao", 50, "05-05-100", "AB", "yes", "Com", 1000, "full professor", 1)
professor1.set_salary()
print(professor1.display_all_info())
print("\n----- Professor2 -----")
professor2 = Professor("Dr.Burawitchaya", 45, "10-10-1970", "A", "yes", "com", 1990, 2, 0)
professor2.set_salary()
print(professor2.display_all_info())

print("\n----- Administrator1 -----")
admin1 = Administrator("best", 35, "20-08-1850", "B", "no", "com", 1890, "manager")
admin1.set_salary()
print(admin1.display_all_info())
print("\n----- Administrator2 -----")
admin2 = Administrator("best2", 38, "15-09-1800", "O", "yes", "com", 1999, 3)
admin2.set_salary()
print(admin2.display_all_info())

print("\n----- UndergraduateStudent -----")
under1 = UndergraduateStudent("klaoooooo", 21, "01-01-2000", "AB", "no", 200, "com", "undergraduate", [3.0, 3.5, 4.0], "chess club")
under1.register_course("compo", "interaction", "data structure")
print(under1.display_all_info())

print("\n----- GraduateStudent -----")
grad1 = GraduateStudent("kkkkkkk", 24, "02-02-2000", "A", "no", 2016, "com", "graduate", [3.5, 4.0, 3.0], "Dr.Klao")
